...
Landing for ads / reels. Not the GitHub Pages legal site.
...
- `/affirmation` flow: device shots 18 Aug (`img/landing-01.jpg` · `landing-02.jpg` · `landing-03.jpg`). Hero text only.
...
Point `gratitude.tranquilwaters.in` later if DNS is ready.
